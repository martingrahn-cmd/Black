...
INSERT INTO achievement_defs (id, game_id, title, description, icon, tier, sort_order) VALUES
  ...
  ('ink-well-marked', 'ink', 'Well Marked', 'Score 5,000 points in one run', '🧮', 'bronze', 10),
  ...
  ('ink-straight-as', 'ink', 'Straight A''s', 'Score 25,000 points in one run', '🅰️', 'silver', 18),
  ...
  ('ink-six-figures', 'ink', 'Six Figures', 'Score 100,000 points in one run', '💯', 'gold', 29),
